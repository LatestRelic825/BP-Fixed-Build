...
class NewStoryPurgatory extends MusicBeatState
{
	...
	override function create()
	{
		...
		week1 = new FlxSprite(100, 70).loadGraphic(Paths.image('purgatoryweeks/Rage_Week_art'));
		...
		week2 = new FlxSprite(500, 70).loadGraphic(Paths.image('purgatoryweeks/Hell_Week_art'));
		...
		week3 = new FlxSprite(900, 70).loadGraphic(Paths.image('purgatoryweeks/Dave_Rematch_art'));
...
class Section2Substate extends MusicBeatSubstate
{
	...
	public function new() {
		...
		week4 = new FlxSprite(100, 70).loadGraphic(Paths.image('purgatoryweeks/MinionDu'));
		week4.scale.set(0.8, 0.8);
		week4.updateHitbox();
		week4.antialiasing = ClientPrefs.globalAntialiasing;
		menuItemsSub.add(week4);
		
		week4text = new FlxText(80, 480, 320, "Bandu and\n" + "Bambi Minion Week\n");
		...
		week5 = new FlxSprite(500, 70).loadGraphic(Paths.image('purgatoryweeks/BomBurgDu'));
		...
		week6 = new FlxSprite(900, 70).loadGraphic(Paths.image('purgatoryweeks/Vs Expunged'));
